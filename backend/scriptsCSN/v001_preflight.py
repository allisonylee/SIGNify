"""
v001 — Step 0 preflight for CSN. Read-only against shipping trees.
...
from backend.trainingCSN.paths import CK_ASE, DATA, FEAT, LABELS, abort_if_low_disk, ensure_dirs, free_gb


def main():
    print("step 0 preflight (CSN isolation)")
    ...
    print("  allowed writes:   backend/trainingCSN, backend/scriptsCSN, backend/models, backend/data/lsc50")
