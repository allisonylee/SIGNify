"""LSC50 dataset + the same augmentations GISLR uses. Local copy (do not edit training/)."""
...
from backend.trainingCSN.paths import FEAT, INDEX, LABELS, REST_SIGN  # noqa: E402
...
def signer_independent_split(rows: pd.DataFrame, n_val_signers=1, seed=0):
...
def load_rows() -> pd.DataFrame:
    if INDEX.exists():
        ...
        raise FileNotFoundError("no LSC50 index — run backend.trainingCSN.download_lsc50")
